...
<template>
    ...
    <div v-if="props.show"
        ...
        <div class="bg-primary border-secondary border-4 rounded-3xl py-16 px-32">

            <div class="flex flex-col gap-y-10">
                <h1 class="font-playfair text-6xl underline">Checkout</h1>

                <div class="flex flex-row gap-x-32">
                    <div class="flex flex-col gap-y-10 justify-between">

                        <div>
                            <p class="font-montserrat text-xl font-semibold pb-2">Name</p>
                            <TextInput placeholder="e.g John Doe" />
                        </div>

                        <div>
                            <p class="font-montserrat text-xl font-semibold pb-2">Address</p>
                            <TextInput placeholder="Random Road, Number xxxxx" />
                        </div>

                        <div>
                            <p class="font-montserrat text-xl font-semibold pb-2">Payment Methods</p>
                        ...
                        <div>
                            <p class="font-montserrat text-xl font-semibold pb-2">Card Number</p>
                    ...
                    <div class="flex flex-col justify-center items-center text-3xl gap-y-5 mt-5">
                        <img :src="props.img" class="w-96"/>
                        <p>Qty:</p>
                        <div class="flex flex-row gap-x-10 items-center text-5xl">
                            <button @click="decreaseQty" class="">-</button>
                            <p class="text-3xl">{{ qty }}</p>
