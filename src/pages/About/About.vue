...
<template>
    <section class="flex flex-col items-center justify-center text-center px-10 xl:px-32 gap-y-10 xl:gap-y-32 mt-24 xl:mt-0 h-auto lg:min-h-[70rem]">

        <h1 class="font-playfair text-secondary text-3xl lg:text-5xl xl:text-8xl underline">What is LibraRie?</h1>
